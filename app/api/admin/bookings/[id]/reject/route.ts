...
export async function GET(
  ...
  try {
    ...
    if (currentStatus === 'accepted') {
      return new Response(
        `<html><body style="font-family: Arial; padding: 40px; text-align: center;">
          <h2>ℹ️ Already Accepted</h2>
          <p>This booking was already accepted. Cannot reject an accepted booking.</p>
          <p style="margin-top: 20px;"><a href="${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/admin" style="color: #4A70A9;">View Dashboard</a></p>
        </body></html>`,
        { status: 200, headers: { 'Content-Type': 'text/html' } }
      );
    ...
    try {
      ...
      const rejectionEmailHTML = `
        ...
        <head>
          ...
          <style>
            ...
            .status-badge { display: inline-block; background: #ef4444; color: white; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: bold; }
          </style>
        </head>
        <body>
          <div class="container">
            <div class="header">
              ...
              <p>Your reservation could not be confirmed</p>
            </div>
            <div class="content">
              <p>Hi ${bookingData.userName || 'Guest'},</p>
              <p>Unfortunately, <strong>${bookingData.hotelName}</strong> is unable to accommodate your booking at this time.</p>
              ...
              <div class="booking-details">
                ...
                <div class="detail-row" style="border: none;">
                  ...
                  <span style="font-weight: bold;">₱${bookingData.totalPrice?.toLocaleString()}</span>
                </div>
              </div>
              
              <p>We apologize for the inconvenience. Please feel free to browse other available hotels on HotBook.</p>
              <p style="text-align: center; margin-top: 30px;">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/hotels" style="display: inline-block; background: #4A70A9; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px;">Browse Hotels</a>
              </p>
            </div>
          </div>
        </body>
      ...
      await transporter.sendMail({
        ...
        subject: `Booking Update - ${bookingData.hotelName}`,
      ...
      `<html>
        <head>
          ...
          <style>
            ...
            .reject-icon { font-size: 60px; margin-bottom: 20px; color: #ef4444; }
        ...
        <body>
          <div class="container">
            ...
            <p>The booking has been rejected.</p>
            ...
            <div class="booking-details">
              ...
              <div class="detail-row" style="border: none;">
                <span class="detail-label">Total:</span>
                <span style="font-weight: bold;">₱${bookingData.totalPrice?.toLocaleString() || 'N/A'}</span>
              </div>
            </div>
            
            <p style="font-size: 14px;">The guest will be notified of the rejection.</p>
    ...
    return new Response(
      `<html><body style="font-family: Arial; padding: 40px; text-align: center;">
        <h2>❌ Error</h2>
        <p>Failed to reject booking. Please try again or contact support.</p>
